...
public class ViewAllCollectionPoints extends javax.swing.JInternalFrame {

    static String updateClient;
    JTabbedPane jTabbedPane;

 
    public ViewAllCollectionPoints() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        clientTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CustomerID", "Name", "Address", "Request Date", "Request Time", "CourierFirm"
            }
        ) {
        ...
        manageCustomerForm.setText("Manage Collection Point Form");
...
//        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ViewAllCollectionPoints.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void viewAllButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewAllButtonActionPerformed
        try {
            ...
            CollectionPoint[] array = collectionPointController.showCollectionPoint();
            tableModel.setRowCount(0);
            for (CollectionPoint customerDetail : array) {
                Object row[] = {customerDetail.getCustID(), customerDetail.getName(), customerDetail.getAddress(), customerDetail.getRequestDate(), customerDetail.getRequestTime(),customerDetail.getCourierFirm()};
