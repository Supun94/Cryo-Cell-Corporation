...
public class ViewAllStorage extends javax.swing.JInternalFrame {

    static String updateClient;
    JTabbedPane jTabbedPane;

 
    public ViewAllStorage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        refereshButton1 = new javax.swing.JButton();
        ...
        clientTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CustomerID", "StorageID", "CSCID", "Stor.Date", "Loc.Name", "Fri.No", "CSC.No", "Matr.No"
            }
        ) {
        ...
        viewAllButton.setText("View All Storages");
        ...
        refereshButton1.setBackground(new java.awt.Color(153, 204, 255));
        refereshButton1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        refereshButton1.setText("Delete");
        refereshButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                refereshButton1ActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(refereshButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        manageCustomerForm.setText("Manage Storage Form");
...
//        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ViewAllStorage.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void viewAllButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewAllButtonActionPerformed
        try {
            ...
            Fridge[] array = fridgeController.viewAllStorage();
            tableModel.setRowCount(0);
            for (Fridge customerDetail : array) {
                Object row[] = {customerDetail.getCustID(), customerDetail.getFridgeID(), customerDetail.getCscID(), customerDetail.getStorageDate(), customerDetail.getLocationName(),customerDetail.getFridgeNumber(),customerDetail.getCscNumber(),customerDetail.getMatrixNumber()};
...
//        MainFrame.policyButton.doClick();
    ...
    private void refereshButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refereshButton1ActionPerformed

        int count = clientTable.getSelectedRowCount();
        if (count == 1) {
            try {
                int row = clientTable.getSelectedRow();
                String deleteCID = (String) clientTable.getValueAt(row, 1);
                FridgeController fridgeController = ServerConnector.getServerConnector().getFridgeController();
                try {
                    
                    int res = fridgeController.deleteStorage(deleteCID);
                    if (res > 0) {
                        JOptionPane.showMessageDialog(this, "Deleted");
                        //  LoanManage.refereshTable();
                        //  LoanManage.fillClientomboBox();
                    } else {
            ...
            JOptionPane.showMessageDialog(this, "Please select only one Loan");
        }
        
        
    }//GEN-LAST:event_refereshButton1ActionPerformed
    ...
    private javax.swing.JButton refereshButton1;
